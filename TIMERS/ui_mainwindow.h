...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        startStop->setText(QApplication::translate("MainWindow", "Start", Q_NULLPTR));
